            ...
            <div id='page-header' class='clearfix'>
                <div id='header-logo'>
                    ...
                    <a href='javascript:;' class='tooltip-button hidden' title='Navigation Menu' id='responsive-open-menu'>
                     ...
                     iDOCTOR <i class='opacity-80'>1.0</i>
                </div>
            ...
            <!----    <div class='hide' id='white-modal-80' title='Dialog with tabs'>
                ...
                <div class='user-profile dropdown'>
                    ...
                    <ul class='dropdown-menu float-right'>
                        <li>
                            <a href='user_settings.php' title='Edit Profile' target='_blank'>
                ...
                <div class='dropdown dash-menu'>
                    <a href='javascript:;' data-toggle='dropdown' data-placement='left' class='medium btn primary-bg float-right popover-button-header hidden-mobile mrg15R tooltip-button' title='Dashboard-Menu'>
                    ...
                    <div class='dropdown-menu float-right'>
                        <div class='medium-box'>
                            ...
                            <div class='pad10A dashboard-buttons clearfix'>
                                <a href='dashbord.php' class='btn vertical-button remove-border bg-blue' title=''>
                                    <span class='glyph-icon icon-separator-vertical pad0A medium'>
                                        <i class='glyph-icon icon-dashboard opacity-80 font-size-20'></i>
                                    </span>
                                    <span class='button-content'>Acceuil</span>
                                </a>
                                <a href='doctor.php' class='btn vertical-button remove-border bg-red' title=''>
                                    <span class='glyph-icon icon-separator-vertical pad0A medium'>
                                        <i class='glyph-icon icon-tags opacity-80 font-size-20'></i>
                                    </span>
                                    <span class='button-content'>Ajouter un patient</span>
                                </a>
                                <a href='search_doctor.php' class='btn vertical-button remove-border bg-purple' title=''>
                                    <span class='glyph-icon icon-separator-vertical pad0A medium'>
                                        <i class='glyph-icon icon-sort-amount-asc opacity-80 font-size-20'></i>
                                    </span>
                                    <span class='button-content'>Listes de patients</span>
                                </a>
                                <a href='operation.php' class='btn vertical-button remove-border bg-azure' title=''>
                                    <span class='glyph-icon icon-separator-vertical pad0A medium'>
                                        <i class='glyph-icon icon-bar-chart-o opacity-80 font-size-20'></i>
                                    </span>
                                    <span class='button-content'>operations</span>
                                </a>
                                <a href='consultation.php' class='btn vertical-button remove-border bg-yellow' title=''>
                                    <span class='glyph-icon icon-separator-vertical pad0A medium'>
                                        <i class='glyph-icon icon-laptop opacity-80 font-size-20'></i>
                                    </span>
                                    <span class='button-content'>consultation</span>
                                </a>
